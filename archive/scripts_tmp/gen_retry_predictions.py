"""Generate predictions.jsonl for retry attempt_2 patches."""
import json, os

base = '/mnt/d/condiag-artifacts/condiag/v0/d4_9_batch2_17x4/runs/miniswe'

pairs = [
    ('django__django-12125', 'feedback_retry'),
    ('django__django-12125', 'condiag_retry'),
    ('sympy__sympy-20428', 'feedback_retry'),
    ('sympy__sympy-20428', 'condiag_retry'),
]
...
out = '/mnt/d/condiag-artifacts/condiag/v0/d4_9_batch2_17x4/predictions_retry.jsonl'
